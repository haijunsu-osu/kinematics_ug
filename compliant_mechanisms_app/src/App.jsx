...
import { BookOpen, Video, AppWindow, MessageSquare, Monitor, ChevronRight, ChevronDown, FileText, Globe } from 'lucide-react';
                ...
                <div style={{ flex: 1, overflowY: 'auto', padding: '16px' }}>
                    {courseData.map((module, moduleIdx) => (
                        <div key={moduleIdx} style={{ marginBottom: '20px' }}>
                            ...
                            {/* Module Description */}
                            {module.description && expandedModules[moduleIdx] && (
                                <div style={{
                                    fontSize: '12px',
                                    color: '#6b7280',
                                    fontStyle: 'italic',
                    ...
                    {activeTab === 'about-text' ? (
                        ...
                        <div style={{ flex: 1, padding: '40px', overflowY: 'auto', maxWidth: '800px', margin: '0 auto' }}>
                            <h1 style={{ fontSize: '28px', fontWeight: '700', color: '#1f2937', marginBottom: '24px' }}>
                                About Compliant Mechanisms Learning Materials
                            </h1>
                            ...
                            <div style={{ fontSize: '16px', lineHeight: '1.8', color: '#374151' }}>
                                <p style={{ marginBottom: '20px' }}>
                                    ...
                                    <strong> Compliant Mechanisms</strong> coursework at The Ohio State University.
                                </p>

                                <p style={{ marginBottom: '20px' }}>
                                    This course covers the design and analysis of compliant mechanisms, which gain their mobility
                                    from the deflection of flexible members rather than from movable joints. The course is divided
                                ...
                                <p style={{ marginBottom: '20px' }}>
                                    <strong>Pseudo Rigid Body Models for planar compliant mechanisms</strong> – This module introduces
                                    the concept of pseudo-rigid-body models (PRBM), which simplify the analysis of compliant mechanisms
                                    by approximating flexible members as rigid links with lumped compliance at discrete joints. Topics
                                    include introduction to compliant mechanisms, review of mechanics of materials, PRBM fundamentals,
                                    and kinetostatic analysis.
                                </p>

                                <h2 style={{ fontSize: '20px', fontWeight: '600', color: '#1f2937', marginTop: '32px', marginBottom: '16px' }}>
                                    📗 Module 2: Screw Theory
                                </h2>
                                <p style={{ marginBottom: '20px' }}>
                                    <strong>Screw theory approach for design and analysis of spatial compliant mechanisms</strong> –
                                    This module covers advanced methods using screw theory for analyzing and synthesizing spatial
                                    compliant mechanisms and flexure systems. Topics include screw theory review, constraint and
                                    screw theory for flexures, synthesis methods, and compliance matrix techniques for flexure design.
                                </p>
                                ...
                                <ul style={{ marginLeft: '24px', marginBottom: '20px' }}>
                                    ...
                                    <li style={{ marginBottom: '8px' }}><strong>Lecture Videos</strong> – Recorded video explanations (coming soon)</li>
                                    <li style={{ marginBottom: '8px' }}><strong>Interactive Apps</strong> – Design and visualization tools for hands-on learning (coming soon)</li>
                                    <li style={{ marginBottom: '8px' }}><strong>AI Chat (NotebookLM)</strong> – AI-powered Q&A based on course materials (coming soon)</li>
                                </ul>
                                ...
                                <ul style={{ marginLeft: '24px', marginBottom: '20px' }}>
                                    <li style={{ marginBottom: '8px' }}>
                                        <a href="https://haijunsu-osu.github.io/kinematics_ug/course_app/" target="_blank" rel="noopener noreferrer" style={{ color: '#2563eb', textDecoration: 'underline' }}>
                                            <strong>ME 3751 Kinematics and Mechanism Design</strong>
                                        </a>
                                        : Covers kinematics fundamentals, linkage analysis, and cam design.
                                    </li>
                                    <li style={{ marginBottom: '8px' }}>
